...
\subsection*{Results}
The results have shown that the E2ELR model preformed better than the other models in terms of accuracy on every dataset. The E2ELR models also took around the same time to infer a solution as the other models.
